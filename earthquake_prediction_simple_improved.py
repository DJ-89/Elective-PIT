...
# DBSCAN Clustering (Hotspots) - Optimized parameters
# eps=0.05 (~5.5km), min_samples=5 - finer-grained clustering
...
# 7. SPLIT with Stratification and Shuffling
...
# 8. Train XGBoost with Optimized Parameters
...
model = XGBClassifier(
    ...
    n_estimators=100,        # Reduced for memory management
    max_depth=4,             # Reduced for memory management
...
print(f"Processed data saved as 'processed_earthquake_data_improved.csv'")
...
with open('earthquake_analysis_report.txt', 'w') as f:
    f.write(summary_report)

print("Summary report saved as 'earthquake_analysis_report.txt'")